...
**Приватность** DocFetcher не собирает вашу личную информацию. Никакую и никогда. Сомневающиеся могут проверить это, просмотрев [исходный код программы](https://docfetcher.sourceforge.net/wiki/doku.php?id=source_code).
